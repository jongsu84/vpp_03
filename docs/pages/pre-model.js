...
<div class="card"><div class="sh"><div class="st">모델 성능 순위</div><button class="cb p" id="chmp-select-btn" style="font-size:10px" onclick="chmpToggleSelect()">대표모델 설정</button></div>
