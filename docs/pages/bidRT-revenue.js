...
<div class="card"><div class="sh"><div class="st">가상 정산 내역 · 이중정산 기준</div><div style="display:flex;gap:6px"><button class="cb p sm" onclick="rtvDownloadPDF()">PDF 다운로드</button></div></div>
